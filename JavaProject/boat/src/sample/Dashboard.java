...
public class Dashboard extends BorderPane {
    ...
    public Dashboard(Stage window, User user) throws ClassNotFoundException, IOException {
        ...
        edit.setOnAction(e -> {
            ...
            profile.getStylesheets().add("sample/Gui.css");
        ...
        reset.setOnAction(e ->{
            ...
            resetPane.getStylesheets().add("sample/Gui.css");
        ...
        logout.setOnAction(e -> {
            try {
                ...
                loginpage.getStylesheets().add("sample/Gui.css");
        ...
        change.setOnAction(e -> {
            ...
            addImage.getStylesheets().add("sample/Gui.css");
        ...
        parti.setOnAction(e -> {
            try {
                ...
                participant.getStylesheets().add("sample/Gui.css");
        ...
        delete.setOnAction(e -> {
            ...
            try {
                ...
                dashboard.getStylesheets().add("sample/Gui.css");
