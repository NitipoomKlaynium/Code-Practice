    ...
    public Registerpage(Stage window) throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        regisbtn.setOnAction(e -> {
            try {
                if (userin.getText() == null || passin.getText() == null || passincon.getText() == null) {
                    ...
                    window.setScene(new Scene(loginpage, window.getScene().getWidth(),  window.getScene().getHeight()));
                }  else {
        ...
        exit.setOnAction(e -> {
            try {
                ...
                loginpage2.getStylesheets().add("DarkTheme.css");
                window.setScene(new Scene(loginpage2, window.getScene().getWidth(), window.getScene().getHeight()));
            } catch (ClassNotFoundException | IOException e1) {
                e1.printStackTrace();
            }
        });
        ...
        hbBtn.getChildren().addAll(regisbtn, exit);
        grid.add(hbBtn, 1, 4);
